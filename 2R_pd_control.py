...
q = np.array([0, 0], dtype=float)  # Initial joint angles
q_dot = np.array([0, 0], dtype=float)  # Initial joint velocities
q_ddot = np.array([0, 0], dtype=float)  # Initial joint accelerations
Kp, Kd = 15, 4
